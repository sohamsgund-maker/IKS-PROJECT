async function inspectJob() {
  const res = await fetch('https://github.com/aditys4444/cinevault/actions/runs/33303223315');
  const html = await res.text();
  const jobLinks = html.match(/href="\/aditys4444\/cinevault\/actions\/runs\/33303223315\/job\/\d+"/g);
