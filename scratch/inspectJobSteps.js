async function inspectJob() {
  const res = await fetch('https://github.com/aditys4444/cinevault/actions/runs/33303496868');
  const html = await res.text();
  const jobLinks = html.match(/href="\/aditys4444\/cinevault\/actions\/runs\/33303496868\/job\/\d+"/g);
