...
export const VideoPlayer: React.FC<VideoPlayerProps> = ({
  ...
  const attemptMobileAutoLandscape = useCallback(async () => {
    ...
    try {
      ...
      const orientation = (screen as any).orientation || screen.orientation;
  ...
  const initDirectVideo = useCallback(() => {
    ...
    if (isHls && Hls.isSupported()) {
      ...
      hls.on(Hls.Events.ERROR, () => {
        // Automatic silent failover to primary 4K server if direct HLS fails
  ...
  // -------------------------------------------------------------
  // SERVER SWITCHING (Quick failover & mirror switcher)
  // -------------------------------------------------------------
  ...
  // -------------------------------------------------------------
  // SEEKING & VOLUME (For Direct Player)
  // -------------------------------------------------------------
  ...
  return (
    <div
      ...
      className={`relative w-full aspect-video bg-black rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl border border-zinc-800/80 select-none group font-sans ${
    ...
    >
      ...
      {/* TOP STREAM BAR OVERLAY (Clean Netflix Brand Experience) */}
      <div className={`absolute top-0 inset-x-0 z-30 flex items-center justify-between px-3 sm:px-5 py-2.5 bg-gradient-to-b from-black/90 via-black/50 to-transparent transition-opacity duration-300 ${
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={() => setActiveMenu(activeMenu === 'server' ? 'none' : 'server')}
      ...
      {activeServer === 'direct' ? (
        <>
          ...
          <video
            ...
            onError={() => {
              // Seamlessly auto-switch to 4K AutoEmbed on any direct media error
              setActiveServer('autoembed');
          ...
          >
            ...
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-2 sm:gap-3">
                <button onClick={togglePlay} className="p-2 rounded-lg hover:bg-white/15 text-white transition-colors cursor-pointer">
                  {isPlaying ? <Pause className="w-5 h-5 fill-current" /> : <Play className="w-5 h-5 fill-current" />}
                </button>
                <div className="flex items-center gap-1 group/vol">
                  <button onClick={toggleMute} className="p-2 rounded-lg hover:bg-white/15 text-white transition-colors cursor-pointer">
              ...
              <div className="flex items-center gap-1 sm:gap-2">
                ...
                <button onClick={toggleFullscreen} className="p-2 rounded-lg hover:bg-white/15 text-white transition-colors cursor-pointer">
        ...
        <>
          {/* HIGH-SPEED VIP STREAMING EMBED (AutoEmbed 4K, VidLink, Videasy) */}
          <iframe
          ...
          >
            ...
            <button
              ...
              title="Audio Languages (Hindi Default)"
            >
      ...
      {/* ------------------------------------------------------------- */}
      {/* IN-PLAYER POPOVER MENUS (Audio, Servers, Subtitles)            */}
      {/* ------------------------------------------------------------- */}
      ...
      {activeMenu === 'audio' && (
        <div className="absolute inset-0 z-40 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 animate-fade-in">
          <div className="bg-[#141414] border border-zinc-800 rounded-2xl w-full max-w-md p-5 space-y-3 shadow-2xl text-white">
      ...
      {activeMenu === 'speed' && (
        <div className="absolute inset-0 z-40 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 animate-fade-in">
          <div className="bg-[#141414] border border-zinc-800 rounded-2xl w-full max-w-sm p-5 space-y-4 shadow-2xl text-white">
            <div className="flex items-center justify-between pb-2 border-b border-zinc-800">
              <div className="flex items-center gap-2">
      ...
      {activeMenu === 'subtitles' && (
        <div className="absolute inset-0 z-40 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 animate-fade-in">
          <div className="bg-[#141414] border border-zinc-800 rounded-2xl w-full max-w-sm p-5 space-y-3 shadow-2xl text-white">
            <div className="flex items-center justify-between pb-2 border-b border-zinc-800">
              <div className="flex items-center gap-2">
